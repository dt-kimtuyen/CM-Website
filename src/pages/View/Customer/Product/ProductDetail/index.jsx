              ...
              {product.expirationDate && (
                <>
                  {isExpired(product.expirationDate) ? (
                    <Typography sx={{ color: 'red', marginY: 2 }}>
                      Sản phẩm đã hết hạn vào {formatDate(product.expirationDate)}
                    </Typography>
                  ) : isExpiringSoon(product.expirationDate) ? (
                    <Typography sx={{ color: 'orange', marginY: 2 }}>
                      Sản phẩm sắp hết hạn vào {formatDate(product.expirationDate)}.
                    </Typography>
                  ) : (
                    <Typography sx={{ color: 'green', marginY: 2 }}>
                      Hạn sử dụng: {formatDate(product.expirationDate)}
                    </Typography>
                  )}
                </>
              )}
